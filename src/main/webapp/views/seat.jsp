    ...
    <main class="movie_main">
        <div class="main_movieWrapper">
            ...
            <div class="movie_content">
                ...
                <p class="movie_text">Format: ${requestScope.session.format}</p>
                <p class="movie_text">
                    Available seats: ${requestScope.session.availableSeats}
                </p>
                <p class="movie_text">Price: ${requestScope.session.price}</p>
            </div>
        </div>
        <div class="movie_seats">
            <h2 class="movie_header">Seats</h2>
            <div class="movie_seat_list">
                ...
                <c:forEach var="seat" items="${seats}">
                    ...
                    <div class="movie_seat_form">
                        ...
                        <p class="movie_seat_text">${seat.row}/${seat.number}</p>
                    </div>
                </c:if>
                </c:forEach>
            </div>
