    ...
    <main class="admin_movie_main">
        <div class="admin-movie_wrapper">
            <div>
                ...
                width="240"
                height="300"
                class="admin-movie_img"
            />
                <p class="admin-movie_text descr">${requestScope.session. movie.movieDescriptionList.get(0).title}</p>
            </div>
            <div class="admin-movie_content">
                <div>
                    <span class="admin-movie_text">${requestScope.session.startTime.getHours()}:${requestScope.session.startTime.getMinutes()} - </span>
