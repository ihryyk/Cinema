...
<p>
    Time: ${requestScope.session.startTime.getHours()}:${requestScope.session.startTime.getMinutes()}- ${requestScope.session.endTime.getHours()}:${requestScope.session.endTime.getMinutes()}</p>
<p>
    Date: ${requestScope.session.startTime.toLocalDateTime().getDayOfMonth()} ${requestScope.session.startTime.toLocalDateTime().getMonth()}</p>
